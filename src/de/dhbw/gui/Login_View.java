...
public class Login_View extends JFrame {
	...
	public Login_View() {
		initLogin();
		setLoginButtonListener(new de.dhbw.listener.Login_Listener(this));
		userIDField.addActionListener(new de.dhbw.listener.Login_Listener(this));
		passwordField.addActionListener(new de.dhbw.listener.Login_Listener(this));
	}
